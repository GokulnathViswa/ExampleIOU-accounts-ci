...
object IOUFlowSameHost {
    ...
    class Initiator(val iouValue: Int,
        ...
        */
         ...
         * IOUFlow to create IOUState between accounts in same hosts
         */
        @Suspendable
        override fun call(): SignedTransaction {
            ...
            val iouState = AccountsIOUState(iouValue, lenderAccountKey, borrowerAccountKey, "IOU_CREATED")
            ...
            // No flow session is generated for the local party. Notarise and record the transaction in the party's vault.
            val localSigned = ourIdentity.owningKey?.let {
                serviceHub.signInitialTransaction(txBuilder, listOfNotNull(ourIdentity.owningKey))
            } ?: serviceHub.signInitialTransaction(txBuilder)
            return subFlow(FinalityFlow(localSigned, listOf()))
        }
    }
