...
/*
    Refer001 - Flow to get the AccountsIOUStates of the account passed
 */
@StartableByRPC
class GetIOUOfAccountsFlow(val accountList: List<UUID>) :
    ...
    override fun call(): List<StateAndRef<AccountsIOUState>> {
        ...
        var requestLists = serviceHub.vaultService.queryBy<AccountsIOUState>(QueryCriteria.VaultQueryCriteria(externalIds = accountList)).states
        return requestLists
    }
}
